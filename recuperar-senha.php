            ...
            <div>
              ...
              <form action="recuperar_acesso.php" method="post">
                <div class="form-group mt-2">
                  <label for=""  class="p-1">Digite seu cpf/cnpj:</label>
                  <input name="cpf" type="text" class="form-control" id="" placeholder="Digite aqui">
                </div>
                <?php 
                  if(isset($_GET['e']) && $_GET['e'] == 'o'){ ?>
